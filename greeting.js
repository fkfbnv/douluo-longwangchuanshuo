...
`;
    ...
    (function() {
        ...
        var stageData = [
            ...
            { id: "第零阶段", name: "神界遗孤·金龙王封印（开端前）", age: "0岁", date: "龙王历630年1月18日", icon: "🌌", shot: "万古神界崩裂的碎片坠入斗罗大陆的夜空。我睁开眼时，天穹的裂缝正在愈合——一枚金色的光核坠向远方的山村，随之而来的是婴儿的啼哭。命运在那一刻分岔：我的故事，将与那道金光交错。", events: ["神界乱流，金龙王破封，神核注入婴儿体内","唐三设下18道封印后送子下界","被唐孜然夫妇收养，取名唐舞麟"] },



            { id: "第一阶段", name: "东海学院·蓝银觉醒", age: "6岁", date: "龙王历636年1月-2月", icon: "🌱", shot: "东海城的冬日清晨，红山学院门口排着等待觉醒的孩子。轮到我时，测试水晶纹丝不动——台下传来窃笑。只有角落里那个男孩，捧着被鉴定为废武魂的蓝银草，眼神像埋着火。这座小城的命运，正要被两个“废物”改写。", events: ["红山学院武魂觉醒仪式，蓝银草被判定为废武魂","因天生神力被关注，但魂力低下仍受歧视","金龙王封印出现裂痕，身体开始出现异常"] },



            { id: "第二阶段", name: "天生神力·娜儿之约", age: "6岁", date: "龙王历636年2月-3月", icon: "⚡", shot: "街角传来人群的惊呼——一个瘦小的男孩一拳砸碎了青石阶。他身边站着个银发少女，正安静地看他擦手上的血。她叫娜儿。那天傍晚，我听见他低声对她说：“我会保护你。”谁也没想到，这句话后来震动了一个时代。", events: ["街头一拳打碎石阶，展现超常力量","遇到失忆的娜儿，将其带回家中生活","与娜儿约定，承诺将来保护她"] },



            { id: "第三阶段", name: "东海学院·拜师舞长空", age: "6岁", date: "龙王历636年9月", icon: "🗡️", shot: "东海学院教务处，一个白发青年把一柄细剑搁在桌上，语气冷淡：“我只收一个学生。”全院的孩子都屏住了呼吸。他最终看向人群——指向了那个沉默的蓝银草少年。“你，跟我来。”剑光起处，学院的规矩被劈开了一道口子。", events: ["东海学院入学考核，通过基础测试","舞长空发现其潜力，破格收为弟子","初次了解唐门历史与暗器百解"] },



            { id: "第四阶段", name: "加入唐门·锻造初途", age: "6岁-7岁", date: "龙王历636年9月-12月", icon: "🔨", shot: "铁匠铺的火星溅上我的袖口。门内，一群唐门外门弟子围着一块陨铁争论不休，那个蓝银草少年握锤的姿势生涩却专注，每一锤落下都带着不合年纪的沉稳。他在学锻造。而我知道，他同时也在锻造他自己的路。", events: ["通过唐门入门考核，成为唐门外门弟子","学习锻造基础，首次接触千锻概念","展现远超同龄人的锻造天赋"] },



            { id: "第五阶段", name: "结识伙伴·雏形初现", age: "7岁", date: "龙王历637年1月-3月", icon: "🤝", shot: "学院走廊里，两个少年扭打成一团，灰尘里滚出几声闷响。谁也没料到，这一架打出了后来闻名大陆的搭档。旁边扎马尾的少女抱着本古籍看热闹，唇边带着笑。零班的人正在一个接一个地聚齐——而我，恰好站在了风暴眼里。", events: ["与谢邂因冲突相识，后化敌为友","许小言插班加入，星轮冰杖武魂展示","团队默契初步建立"] },



            { id: "第六阶段", name: "零班成军·联赛初战", age: "7岁", date: "龙王历637年3月-6月", icon: "🏁", shot: "联赛开幕的礼炮在操场上炸开。零班——那个全校没人看好的班，站在最角落。转学生古月站在唐舞麟身边，像一片安静的海。哨声响起时，我看见他们十指扣住彼此的手腕：“七位一体！”全场哗然。", events: ["古月转学至东海学院，展现超强实力","舞长空宣布零班正式成立","首次参加学院联赛，配合初显威力"] },



            { id: "第七阶段", name: "史莱克考核·叩关入门", age: "7岁-8岁", date: "龙王历637年9月", icon: "🏰", shot: "史莱克城的大门在晨雾中升起。海神湖的水汽扑在脸上，黄金古树的枝叶在阳光下像流淌的金液。今天是补考日——精神威压、斗兽场、铡刀门。穿过最后那道门的少年浑身是血，却笑得张扬。他成了史莱克的工读生。", events: ["升灵台试炼，突破第二道封印（黄金龙体）","史莱克补考：精神威压、斗兽场、铡刀门、灵锻考核","浊世出面，破格录取为零班工读生"] },



            { id: "第八阶段", name: "班长竞选·班级之争", age: "约13岁", date: "龙王历637年9月-12月", icon: "⚔️", shot: "擂台四周挤满了人。零班内部的对决——唐舞麟对舞丝朵，拳风扫得观战席上的校服猎猎作响。这不仅是班长的争夺，更是这个新生班级第一次把“服气”两个字打出来。我在人群中听见有人小声说：“以后跟着他，能赢。”", events: ["班长争霸战，与舞丝朵对决","年级对抗赛初露锋芒","班级凝聚力逐步形成"] },



            { id: "第九阶段", name: "锻造委员·浊世传艺", age: "约13岁-14岁", date: "龙王历638年1月-3月", icon: "🔥", shot: "锻造室里的温度能把人的眉毛燎卷。那位暴躁的老前辈枫无羽拍着案台吼：“笨！这块铁不该这么走锤！”骂声里，一记又一记带着怒火的锤法却落进少年手里。金龙惊天第一式，就是在这样的骂声中悄悄生了根。", events: ["枫无羽强收为徒，锻造师协会打工","浊世传授金龙惊天第一式","锻造水平突破灵锻"] },



            { id: "第十阶段", name: "武魂融合·神龙初现", age: "约14岁", date: "龙王历638年3月-6月", icon: "🐉", shot: "年级对抗赛最后一回合。唐舞麟与古月的身影在光芒中重合——七彩龙影冲天而起，威压让全场的魂导灯同时熄灭。那一刻，连裁判都忘了吹哨。人群炸开，而我忽然明白：他们俩之间，藏着远超同学的情愫和秘密。", events: ["年级对抗赛中意外触发武魂融合技","七彩龙影震惊全场","老唐现身警告，禁止再次使用"] },



            { id: "第十一阶段", name: "蓝银皇觉醒", age: "约14岁", date: "龙王历638年9月", icon: "🌿", shot: "深海训练场，水压把光线压成一条条细线。那个少年在水底蜷成胎儿般的姿势，整整四十九天。当他被拖上来的那天，掌心的蓝银草蜕变成了皇者的金蓝——草叶舒展的瞬间，整片海水仿佛都在臣服。", events: ["深海特训四十九天，承受极限压力","牧野以特殊手法激发血脉","蓝银草蜕变，二次觉醒为蓝银皇"] },



            { id: "第十二阶段", name: "星罗联谊·群英荟萃", age: "约14岁", date: "龙王历638年9月-10月", icon: "🚢", shot: "星罗号的甲板上灯火通明，乐声浮在海面上。各国的青年才俊端着酒杯穿梭，礼貌的笑容下是暗流。我第一次见到这么大阵仗的社交场——而那个穿着礼服的蓝银草少年，正被星罗帝国的贵族小姐们围在中间，一脸窘迫。", events: ["星罗号巨轮联谊宴会","结识星罗帝国各方青年才俊","与怪物学院选手初次交锋"] },



            { id: "第十三阶段", name: "星罗大赛·小组赛", age: "约14岁", date: "龙王历638年10月-11月", icon: "🥊", shot: "星罗大赛的擂台上，欢呼声像潮水一样涨落。唐舞麟所在的队伍一路横扫小组赛。我看得分明：他的魂技还带着几分青涩，可那股子“打不倒”的狠劲，让所有对手都皱起了眉头。", events: ["小组赛多场连胜","史莱克七怪配合愈发默契","引起星罗帝国高层关注"] },



            { id: "第十四阶段", name: "星罗大赛·夺冠扬名", age: "约14岁", date: "龙王历638年11月-12月", icon: "🏆", shot: "决赛最后一刻，七彩龙影与对手的武魂轰然相撞。龙跃倒在台上，唐舞麟拄着黄金龙枪站起——那是他第一次在天下人面前拔出这把枪。观众席沉默了半秒，随后爆发出海啸般的欢呼。史莱克的名字，从此响彻大陆。", events: ["个人赛连战连捷","决赛龙跃重创唐舞麟，牧野出手相救","冲破第六道封印，拔出黄金龙枪","七对七神龙变碾压龙跃，史莱克夺冠"] },



            { id: "第十五阶段", name: "龙谷行动·启程", age: "约15岁", date: "龙王历639年1月", icon: "🗺️", shot: "龙谷的入口像一个巨大的咽喉，吞吐着远古的风。唐门召集令一下，各色魂师在谷外汇合。有人兴奋，有人不安。那个背负重任的蓝银草少年站在最前——他的背影告诉我：此去，凶险万分，却也注定名动天下。", events: ["唐门发布龙谷行动召集令","与星罗帝国选手组队进入","穿越龙谷入口的能量屏障"] },



            { id: "第十六阶段", name: "龙谷探秘·千日葬龙", age: "15岁-18岁", date: "龙王历639年1月-642年1月", icon: "🦴", shot: "龙谷深处，巨龙的骸骨绵延如山。三年四个月——他一个人，一柄锤，为那些从未被安葬的龙王修起了墓。锤声在空旷的谷底回荡了上千个日夜。我远远看着那个沉默的身影，第一次懂得：有些力量，是从“敬畏”里长出来的。", events: ["进入龙谷，武魂被封印","吸收龙云强化体魄，救助戴云儿","龙墓安葬巨龙骸骨（耗时三年四个月）","获赠山龙王躯干骨"] },



            { id: "第十七阶段", name: "金龙王核心传承", age: "约18岁", date: "龙王历642年1月-2月", icon: "✨", shot: "龙谷最深处，金色的光柱直冲天穹。当金龙王的核心融入他胸口时，整个龙谷都在震颤，沉睡的龙魂发出低吟，仿佛在行礼。封印再度松动——他闭上眼睛，再睁开时，眼底有金芒一闪而过。他握了握拳：“该回去了。”", events: ["通过龙族最终考验","金龙王核心融入体内","封印进一步松动，力量暴涨"] },



            { id: "第十八阶段", name: "回归史莱克·海神缘前", age: "约18岁", date: "龙王历642年9月", icon: "🎓", shot: "史莱克城用英雄的礼遇迎接归来的少年。海神湖的桥上站满了人，他走过欢呼的人潮，目光却在人群中搜寻着什么。海神缘大会将至——今晚的湖水，注定不太平静。", events: ["从龙谷归来，修为大增","史莱克学院以英雄之礼迎接","海神缘大会即将召开"] },



            { id: "第十九阶段", name: "海神缘定情", age: "约18岁", date: "龙王历642年9月", icon: "🌸", shot: "海神缘大会，红绳在月光下牵起宿命。当那根绳子的另一端落入古月手中时，全场都屏住了呼吸。两个肩负着对立使命的人，此刻只是并肩站在湖心，谁也不愿松手。风把他的话送得很远：“这一次，我不会放开你。”", events: ["海神缘大会上力压群雄","与古月互诉心声","正式确立情侣关系"] },



            { id: "第二十阶段", name: "魔鬼岛特训启程", age: "约18岁", date: "龙王历642年10月", icon: "⛵", shot: "船头劈开灰黑色的海浪，魔鬼岛的轮廓在雾中若隐若现。岛上据说有七位能把人逼疯的老怪物。同行的学员们面色凝重，而那个蓝银草少年站在桅杆下，望着岛屿的方向，眼里竟有一丝跃跃欲试。", events: ["收到魔鬼岛特训征召","与七怪一同登船前往","抵达魔鬼群岛"] },



            { id: "第二十一阶段", name: "魔鬼岛极限磨砺", age: "18岁-19岁", date: "龙王历642年10月-643年3月", icon: "🌋", shot: "魔鬼岛的试炼没有一天是轻松的。碎骨重组——骨头一寸寸裂开又接上的痛，让再硬气的人都惨叫出声。他也在叫，但叫完又站起来：“再来。”生命潮汐里，一粒魂核的雏形在他体内悄然凝聚。", events: ["魔鬼岛七老魔试炼（碎骨重组、恐惧幻境、欲望测试）","生命潮汐中凝聚魂核雏形","团队配合愈发默契"] },



            { id: "第二十二阶段", name: "北海军团偷飞机", age: "约19岁", date: "龙王历643年3月-4月", icon: "✈️", shot: "深夜的北海军团基地，探照灯扫过停机坪。一伙人贴着阴影潜行——目标是那架新型机甲。警报炸响的那一刻，我看见他拽着驾驶杆把机甲拉出机库，迎面撞上三架拦截机，愣是靠操作把追兵甩进了山谷。", events: ["奉命窃取北海军团新型机甲","成功完成任务并全身而退","引发军方震动，反被嘉奖"] },



            { id: "第二十三阶段", name: "圣灵教初现", age: "约19岁", date: "龙王历643年4月-6月", icon: "🌑", shot: "最近两个月，大陆各地接连出现邪魂师的痕迹——失踪的孩子、被掏空的魂兽巢穴。传灵塔与联邦高层里，也开始有人收到诡异的黑信。茶余饭后，人们压低声音议论着三个字：圣灵教。空气里有什么东西正在悄悄变质。", events: ["大陆各地多次出现邪魂师作乱","圣灵教渗透传灵塔与联邦高层","史莱克学院开始警觉"] },



            { id: "第二十四阶段", name: "深渊威胁显现", age: "约19岁", date: "龙王历643年6月-9月", icon: "🕳️", shot: "极北之地的边境哨所发来加急传信：深渊裂缝正在扩大，黑色的潮汐吞没了两个补给站。血神军团的警报拉响时，我看见老兵们擦拭武器的动作变快了。暗涌多年的大陆，终于要被推到台前。", events: ["深渊生物开始在极北之地出现","血神军团发出警报","联邦高层内部分歧加剧"] },



            { id: "第二十五阶段", name: "史莱克浩劫", age: "约19岁", date: "龙王历643年9月-10月", icon: "💥", shot: "那一天，史莱克城的天空被一道光撕开——弑神级炮弹落下。我脚下的土地在震颤，海神湖的水被气浪掀上天空又砸落。昔日辉煌的学院在火海中坍塌，海神阁的旗帜坠入烟尘。这个世界，被一炮轰进了深渊时代。", events: ["圣灵教发射弑神级炮弹","史莱克城被毁，云冥牺牲","海神阁几乎全军覆没"] },



            { id: "第二十六阶段", name: "流亡之路", age: "19岁-20岁", date: "龙王历643年10月-12月", icon: "🥾", shot: "地下避难层的通风管呜呜作响。史莱克残存的师生换上便装，分头消失在城市的各个角落。他带着古月西行，临别时对我们说：“活着，才有以后。”我开始习惯在夜里赶路，习惯把名字藏起来——圣灵教的眼线，已经布满了大陆。", events: ["七怪幸存，进入地下避难层","分兵潜伏，各自历练","唐舞麟带古月前往西方"] },



            { id: "第二十七阶段", name: "冰火两仪眼", age: "约20岁", date: "龙王历644年1月-6月", icon: "⚗️", shot: "冰火两仪眼的泉水一半灼烫一半彻骨，泉边竟长着只在传说里存在的仙草。当那株绮罗郁金香亮起光芒时，六大植物凶兽的身影自光芒中浮现——它们选择献祭，成为他的本命魂灵。那一年，他沉默地变强，强到让人心疼。", events: ["冰火两仪眼，六大植物凶兽献祭","绮罗郁金香等成为本命魂灵","实力暴涨，奠定魂圣基础"] },



            { id: "第二十八阶段", name: "极北之地冒险", age: "20岁-21岁", date: "龙王历644年6月-12月", icon: "❄️", shot: "极北的风像刀子，刮在脸上生疼。雪原深处，深渊生物的黑色剪影时隐时现。我与一队魂师结成临时防线，远处，那个身影正在与一只深渊领主缠斗——自然之种在他胸口发光，像雪夜里的一盏灯。", events: ["极北之地遭遇深渊生物袭击","与当地魂师势力建立联系","自然之种进一步生长"] },



            { id: "第二十九阶段", name: "唐昊现身", age: "约21岁", date: "龙王历645年1月-3月", icon: "🌩️", shot: "雨夜，一个邋遢的男人敲开了我们的避雨小屋。他一身酒气，却在看见唐舞麟时目光骤然清明。“像，太像了。”他喃喃着，忽然周身气息暴涌，昊天锤的虚影在雨幕中一闪而逝。那是少年第一次触摸到自己的身世。", events: ["唐昊以神识之体降临","告知唐三与神界的安排","唐舞麟初知自己的神界身世"] },



            { id: "第三十阶段", name: "圣灵教终极阴谋", age: "约21岁", date: "龙王历645年3月-6月", icon: "🕸️", shot: "传灵塔的顶层会议厅大门紧闭，据说已被邪魂师渗透；联邦最高议会的表决屡屡被神秘力量搅黄。茶馆里的人们开始不敢议论国事。那张看不见的网正一寸寸收紧——圣灵教筹备多年的终极阴谋，就要收网了。", events: ["圣灵教渗透联邦最高议会","传灵塔被邪魂师控制","深渊位面与圣灵教暗中勾结"] },



            { id: "第三十一阶段", name: "深渊决战开启", age: "约21岁", date: "龙王历645年6月-9月", icon: "⚔️", shot: "极北防线上，联军旌旗猎猎。深渊裂口像一道黑色的伤口横亘大地，无数狰狞的身影正从其中涌出。他站在联军最前方，生命子树的光辉在他身后铺开成墙。号角吹响的那一刻，我握紧武器，冲进了那片黑色的潮水。", events: ["极北防线全面告急","生命子树扎根极北","唐舞麟统帅联军迎战"] },



            { id: "第三十二阶段", name: "使命对立", age: "21岁-22岁", date: "龙王历645年9月-12月", icon: "💔", shot: "决战胜利的喜悦还没来得及扩散，更大的风暴降临——古月娜的身份暴露了。魂兽之主与人类领袖，隔着整个大陆的对立站在了他面前。那晚我看见他站在营帐外，望着星空站了一整夜。", events: ["古月娜身份彻底暴露（银龙王）","魂兽阵营与人类阵营对峙","两人因使命对立而决裂"] },



            { id: "第三十三阶段", name: "最终对决", age: "约22岁", date: "龙王历646年1月-3月", icon: "☄️", shot: "万米高空之上，金色与银色的光芒碰撞，云层被撕成碎片。龙神之力对银龙王之力——大陆上最强的两个人，正在用最惨烈的方式相爱。每一次对撞都让大地颤抖。我仰头望着那两道纠缠的光，喉咙发紧。", events: ["两人于万米高空对决","龙神之力VS银龙王之力","难分胜负，双双力竭"] },



            { id: "第三十四阶段", name: "永冻冰封", age: "26岁", date: "龙王历656年1月18日", icon: "🧊", shot: "极北冰海上空，银色的光芒铺满苍穹。她发动了冰封禁咒——整片海域在瞬息间凝成永恒的白。两道身影在坠落中相拥，冰层合拢，将他们封在海底深处。世界安静了。可我知道，那个关于重生的传说，才刚刚埋下种子。", events: ["古月娜发动冰封禁咒","两人相拥坠入极北冰海","身体被永恒冰层包裹，沉入海底","为终极斗罗唐舞麟复活埋下伏笔"] }
...
function getSpecialDisplay(){
        ...
        function collectData(){
            ...
            return {
                ...
                "降临阶段": stage ? { "阶段": stage.id, "名称": stage.name, "年龄": stage.age, "时间": stage.date, "切入事件": eventVal||'', "icon": stage.icon||'', "首帧画面": stage.shot||'', "来意": getVal('stageGoal')||'' } : null,
