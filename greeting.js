...
`;
    ...
    (function() {
        ...
        function onStageSelect(){
            ...
            var autoGreet = '✦ 降临 · ' + stage.id + ' ' + stage.name + '｜' + stage.date;



            fields.greeting.value = autoGreet;
        ...
        function onStageEventSelect(){
            ...
            if(stageId){
                ...
                var st = stageData.find(function(s){ return s.id === stageId; });



                if(st) fields.greeting.value = '✦ 降临 · ' + st.id + ' ' + st.name + '｜' + st.date + (fields.stageEventSelect.value ? '｜' + fields.stageEventSelect.value : '');
