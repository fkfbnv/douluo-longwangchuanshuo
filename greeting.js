// ========== greeting.js - 斗罗大陆III 龙王传说 魂师档案 v24.0（8步重构·特殊能力独立·天生异禀加段）==========
...
#toast{position:absolute;top:12px;left:50%;transform:translateX(-50%) translateY(-20px);z-index:999;background:rgba(10,18,32,0.96);border:1px solid rgba(255,215,0,0.2);border-radius:14px;padding:8px 20px;color:#fbbf24;font-size:.75em;letter-spacing:1px;opacity:0;transition:opacity .4s,transform .4s;pointer-events:none;box-shadow:0 4px 30px rgba(0,0,0,0.5),0 0 30px rgba(255,215,0,0.05)}
...
#fieldIndicator{position:absolute;bottom:12px;left:50%;transform:translateX(-50%);background:rgba(10,18,32,0.96);border:1px solid rgba(255,215,0,0.1);border-radius:12px;padding:3px 14px;font-size:.5em;color:#94a3b8;opacity:0;transition:opacity .3s;pointer-events:none;z-index:98;white-space:nowrap;max-width:80%;overflow:hidden;text-overflow:ellipsis}
...
.btn-row{position:absolute;bottom:0;left:0;right:0;z-index:100;background:linear-gradient(180deg,transparent 0%,rgba(10,18,32,0.98) 25%,#0a1220 100%);padding:6px 16px 10px 16px;display:flex;flex-direction:row;align-items:center;gap:8px;border-top:1px solid rgba(255,215,0,0.04)}
...
#awakenOverlay{position:absolute;top:0;left:0;right:0;bottom:0;z-index:999;background:rgba(0,0,0,0.94);display:none;justify-content:center;align-items:center;flex-direction:column;padding:20px}
...
#fateModal{position:absolute;top:0;left:0;right:0;bottom:0;z-index:998;background:rgba(0,0,0,0.85);display:none;justify-content:center;align-items:center;padding:16px}
...
.special-tier .tier-tag.t6.active.special-item{margin-top:6px;border:1px solid rgba(255,255,255,0.08);border-radius:10px;padding:8px 10px;background:rgba(0,0,0,0.12)}
.special-item[data-hidden="1"]{display:none}
.special-item .fd label{display:flex;align-items:center;gap:4px;font-size:.65em;color:#94a3b8;margin-bottom:3px}
.sf-icon{display:inline-flex;width:16px;height:16px;border-radius:50%;align-items:center;justify-content:center;font-size:.55em;flex-shrink:0}
.icon-spirit{background:rgba(255,215,0,0.18);color:#fbbf24}
.icon-art{background:rgba(255,107,107,0.15);color:#ff6b6b}
.icon-blood{background:rgba(76,201,176,0.15);color:#4ac9b0}
.blood-row .rw{display:grid;grid-template-columns:1fr 1fr;gap:8px}
.blood-row .fd{margin-bottom:0}
...
<div class="sec" data-step="2">
  ...
  <div class="rw"><div class="fd"><label>所属阵营</label><select id="fc"><option value="无">无</option><option value="史莱克学院">史莱克学院</option><option value="唐门">唐门</option><option value="传灵塔">传灵塔</option><option value="战神殿">战神殿</option><option value="血神军团">血神军团</option><option value="本体宗">本体宗</option><option value="锻造师协会">锻造师协会</option><option value="机甲师协会">机甲师协会</option><option value="斗魂堂">斗魂堂</option><option value="星罗帝国">星罗帝国</option><option value="斗灵帝国">斗灵帝国</option><option value="斗罗联邦">斗罗联邦</option><option value="圣灵教">圣灵教</option><option value="昊天宗">昊天宗</option><option value="原恩家族">原恩家族</option><option value="自由魂师">自由魂师</option><option value="散修">散修</option></select></div><div class="fd"><label>阵营身份</label><select id="fbg"><option value="无">无</option></select></div></div>



  

  <div class="fd"><label>储物魂导器 <sm>(点击标签可移除，可添加物品)</sm></label>
    ...
    <div style="display:flex;gap:3px;margin-top:2px;">
      ...
      <input type="text" id="backpackInput" placeholder="添加物品，如：储物魂导器(容量30)" style="flex:1;min-height:28px;font-size:.7em;">
...
<div class="sec" data-step="3">
  <div class="step-guide">✦ 第三步 · 特殊能力</div>
  <div class="fd"><label>能力等级</label>
    ...
    <div id="specialWeaponWrap" class="special-item" data-hidden="0">
      <div class="fd"><label><span class="sf-icon icon-spirit">✦</span><span id="spiritLabel">专属武魂</span></label><input type="text" id="specialWeapon" style="background:rgba(255,255,255,0.06);border-color:rgba(255,255,255,0.12);color:#fbbf24;font-weight:700;"></div>
    </div>

    <div id="specialArtifactWrap" class="special-item" data-hidden="0">
      <div class="fd"><label><span class="sf-icon icon-art">❖</span><span id="artifactLabel">神器</span></label><input type="text" id="specialArtifact" style="background:rgba(255,255,255,0.06);border-color:rgba(255,255,255,0.12);color:#ff6b6b;font-weight:700;"></div>
    </div>

    <div id="bloodWrap" class="special-item blood-row" data-hidden="0">
      <div class="rw">
        <div class="fd blood-half"><label><span class="sf-icon icon-blood">◈</span><span id="bloodLabel">血脉</span></label><input type="text" id="bloodName" style="background:rgba(255,255,255,0.06);border-color:rgba(255,255,255,0.12);color:#4ac9b0;font-weight:700;"></div>
        <div class="fd blood-half"><label>血脉觉醒程度</label><select id="bloodAwaken"><option value="未觉醒">未觉醒</option><option value="初步觉醒">初步觉醒</option><option value="深度觉醒">深度觉醒</option><option value="完全觉醒">完全觉醒</option><option value="返祖/巅峰">返祖/巅峰</option></select></div>
      </div>
    </div>

    <div style="font-size:.5em;color:#94a3b8;margin-top:2px;" id="costDesc"></div>

    <div id="customSpecialWrap" class="custom-wrap" style="display:none;margin-top:2px;">
      <div class="custom-title">✎ 自定义能力</div>
      <div class="fd"><label>自定义能力名称</label><input type="text" id="customSpecialName" placeholder="如：星辰之力" style="background:rgba(255,255,255,0.06);border-color:rgba(255,255,255,0.12);"></div>
      <div class="fd"><label>自定义能力描述</label><input type="text" id="customSpecialDesc" placeholder="如：可引动星辰之力进行攻击" style="background:rgba(255,255,255,0.06);border-color:rgba(255,255,255,0.12);"></div>
    </div>
  </div>
</div>

<div class="sec" data-step="4">
  <div class="step-guide">✦ 第四步 · 武魂与魂力</div>
  <div class="core-group">
...
<div class="sec" data-step="5">
  ...
  <div class="step-guide">✦ 第五步 · 精神力、定位与魂骨</div>
  ...
  <div class="core-group">
    ...
    <div class="fd"><label>精神力境界</label><select id="sp"><option value="未知/未测定">未知/未测定</option><option value="灵通境">灵通境</option><option value="灵海境">灵海境</option><option value="灵渊境">灵渊境</option><option value="灵域境">灵域境</option><option value="神元境">神元境</option><option value="神王境">神王境</option></select></div>
...
<div class="sec" data-step="6">
  ...
  <div class="step-guide">✦ 第六步 · 魂灵与魂环</div>
  ...
  <div class="hl">
    ...
    <div class="fd" id="spiritYearWrap"><label>年限</label>
      ...
      <div class="spirit-year-select">
        ...
        <select id="ssy"><option value="无">无</option><option value="十年">十年</option><option value="百年">百年</option><option value="千年">千年</option><option value="万年">万年</option><option value="十万年">十万年</option><option value="凶兽">凶兽</option></select>
...
<div class="sec" data-step="7">
  ...
  <div class="step-guide">✦ 第七步 · 斗铠、机甲与第二职业</div>
  ...
  <div class="core-group">
    ...
    <div class="fd"><label>斗铠侧重</label><select id="bat"><option value="不适用">不适用</option><option value="力量型">力量型</option><option value="敏捷型">敏捷型</option><option value="防御型">防御型</option><option value="爆发型">爆发型</option><option value="控制型">控制型</option></select></div>
  ...
  <details><summary>✦ 机甲 <span class="ar">▼</span></summary>
    ...
    <div class="sb"><div class="in">
      ...
      <div class="fd"><label>机甲等级</label><select id="mechaLevel"><option value="无">无</option><option value="黄级">黄级</option><option value="紫级">紫级</option><option value="黑级">黑级</option><option value="红级（自定义）">红级（自定义）</option></select></div>
  ...
  <details><summary>✦ 第二职业 <span class="ar">▼</span></summary>
    ...
    <div class="sb"><div class="in">
      ...
      <div class="secondary-grid"><div class="fd"><label>第二职业</label><select id="secondProf"><option value="无">无</option><option value="锻造师">锻造师</option><option value="机甲制作">机甲制作</option><option value="机甲设计">机甲设计</option><option value="机甲维修">机甲维修</option><option value="自定义">自定义</option></select></div><div class="fd"><label>等级</label><select id="secondLevel"><option value="0">0级</option><option value="1">1级</option><option value="2">2级</option><option value="3">3级</option><option value="4">4级</option><option value="5">5级</option><option value="6">6级</option><option value="7">7级</option><option value="8">8级</option><option value="9">9级</option></select></div></div>
...
<div class="sec" data-step="8">
  ...
  <div class="step-guide">✦ 第八步 · 降临与命运</div>
  ...
  <details><summary>✦ 降临与命运 <span class="ar">▼</span></summary>
    ...
    <div class="sb"><div class="in">
      ...
      <div id="stageDetail" style="display:none;">
        ...
        <div class="stage-detail-card">
          ...
          <div class="stage-events">
            ...
            <div style="display:none;margin-top:5px;padding:6px 8px;background:rgba(0,0,0,0.22);border-left:2px solid rgba(255,215,0,0.18);border-radius:4px;font-size:.6em;color:#94a3b8;font-style:italic;line-height:1.7;" id="stageShotPreview"></div>
      ...
      <div class="fd" style="margin-top:6px;"><label>来此目的 <sm style="color:#64748b;">可选 · 一句话说明你此刻为何在此</sm></label><input type="text" id="stageGoal" placeholder="如：寻找失散多年的亲人｜为参加魂师大赛而来｜只是路过这座城市"></div>
...
`;
    ...
    (function() {
        ...
        var fields = {
            ...
            bloodAwaken: $('bloodAwaken'), bloodName: $('bloodName'), bloodWrap: $('bloodWrap'),
            ...
            spiritLabel: $('spiritLabel'), artifactLabel: $('artifactLabel'), bloodLabel: $('bloodLabel'),
            ...
            stageGoal: $('stageGoal'), stageShotPreview: $('stageShotPreview'),
        ...
        var STORAGE_KEY = 'soul_archive_v24';
        ...
        var originList = ['东海城','傲来城','史莱克城','天斗城','星罗城','灵波城','明都','星斗大森林外围','极北之地','西海城','南海城','北海城','落日森林','龙谷外围','血神军团驻地','魔鬼岛','无尽山脉入口','海神岛','天海城','升灵台入口','永恒天空城','魂兽森林边缘','神界遗地'];



        var campIdentityLinks = {
            '无':['无'],
            '史莱克学院':['外院学员','内院学员','工读生','助教','导师','海神阁成员','史莱克七怪','零班','监察团成员'],
            '唐门':['外门弟子','内门弟子','斗魂堂成员','敏堂成员','力堂成员','御堂成员','供奉堂成员','堂主','长老'],
            '传灵塔':['传灵使','塔员','分塔主','塔主','千古家族成员','传灵塔议员','副塔主'],
            '战神殿':['预备战神','正式战神','神将','副殿主','殿主','第零号小队成员'],
            '血神军团':['普通士兵','军官','血神卫','血神营成员','军团长'],
            '本体宗':['本体战士','核心弟子','亲传弟子','宗老','宗主'],
            '锻造师协会':['学徒','初级锻造师','中级锻造师','高级锻造师','宗匠','神匠','协会会长'],
            '机甲师协会':['见习机甲师','正式机甲师','王牌机甲师','机甲设计师','机甲制造师'],
            '斗魂堂':['红级斗者','橙级斗者','堂主'],
            '星罗帝国':['平民','官员','供奉','皇族','御林军','怪物学院学员'],
            '斗灵帝国':['平民','官员','皇族'],
            '斗罗联邦':['公民','联邦议员','军部军官','联邦议长'],
            '圣灵教':['外围成员','核心成员','天王','教主'],
            '昊天宗':['外门弟子','核心弟子','长老','宗主'],
            '原恩家族':['家族子弟','核心成员','家主'],
            '自由魂师':['自由魂师'],
        ...
        var fixedIdentityOptions = ['无','普通平民','孤儿','魂师世家','宗门嫡系','皇室宗亲','隐世家族','魂兽化形','神祇后裔','龙族后裔'];
        ...
        var backpackPresets = {
            ...
            '锻造师协会':['锻造师协会徽章','锻造锤（学徒级）','锻造图纸集'],



            '机甲师协会':['机甲师协会徽章','机甲维修工具','机甲设计图'],
        ...
        var backpackOriginPresets = {
            ...
            '无尽山脉入口':['无尽山脉地图','登山工具','野外生存包'],'海神岛':['海神岛通行令牌','海洋图鉴','防水魂导器'],'天海城':['天海城通行令牌','城市地图','商队凭证'],'升灵台入口':['升灵台试炼凭证','魂灵图鉴','野外生存包'],'永恒天空城':['天空城通行令牌','内院服饰','永恒树叶'],'魂兽森林边缘':['森林采集许可','野外生存包','驱虫香'],'神界遗地':['神界遗物（残）','神秘晶石','未知信物']
        ...
        var specialDataT4 = [
            { name: '听雪无痕', desc: '雪落无声，天地间一切细微动静尽收心底，对手的杀意、脚步、呼吸都无所遁形。', spirit: '雪聆' },
            { name: '望舒御月', desc: '身披月华，招式如月光倾泻般迅疾无声，攻速与身法随月色流转。', spirit: '月御' },
            { name: '折桂夺运', desc: '隔空折取对手的运势与优势，令其频频失手，而好运悄然偏向你。', spirit: '桂魄' },
            { name: '拾光藏影', desc: '收集光与影存入体内，临战一次性释放，光愈烈则威愈盛。', spirit: '流光' },
            { name: '层峦叠嶂', desc: '每挡下一次攻击便叠加一层山影，层层累积，愈战愈坚。', spirit: '万壑' },
            { name: '烛龙昼夜', desc: '睁眼为昼，闭眼为夜，可逆转一方天地明暗，令对手目不能视。', spirit: '烛阴' },
            { name: '洛书推演', desc: '以数字阵图推演战局，提前预判对手一切行动轨迹。', spirit: '河图' },
            { name: '息壤造物', desc: '泥土随心而生，可筑墙、塑傀儡、困敌于地，生生不息。', spirit: '后土' },
            { name: '惊弦破空', desc: '弓弦之鸣未响先至，音爆撕裂空气，攻速极快、防不胜防。', spirit: '弓鸣' },
            { name: '青萍借力', desc: '起于青萍之末，借天地之势四两拨千斤，以柔克刚。', spirit: '微尘' }
        ];

        var specialDataT5 = [
            { name: '沧海桑田', desc: '以岁月为刃，令目标随心意快速老化或返青，沧海可变桑田。', spirit: '沧海', artifact: '光阴梭', cost: '日常无代价，逆天时轻微代价（可逆），神器可减轻' },
            { name: '忘川渡魂', desc: '掌记忆之河，可读取、封存、洗去他人的记忆片段。', spirit: '忘川', artifact: '三生石', cost: '日常无代价，逆天时轻微代价（可逆），神器可减轻' },
            { name: '浮生若梦', desc: '虚实边界随你而移，梦中所见可化为真实，真实亦可沉入梦境。', spirit: '浮生', artifact: '黄粱枕', cost: '日常无代价，逆天时轻微代价（可逆），神器可减轻' },
            { name: '御风逍遥', desc: '乘风而行，无视地形障碍，天地之大任你遨游。', spirit: '逍遥', artifact: '青云履', cost: '日常无代价，逆天时轻微代价（可逆），神器可减轻' },
            { name: '红豆相思', desc: '以情为线，种下相思，千里之外亦可感应对方所在与心境，相互牵引。', spirit: '相思', artifact: '同心结', cost: '日常无代价，逆天时轻微代价（可逆），神器可减轻' },
            { name: '衡鉴秋毫', desc: '明察秋毫，清算因果，善恶有报，作恶者自食其果。', spirit: '衡鉴', artifact: '秦镜', cost: '日常无代价，逆天时轻微代价（可逆），神器可减轻' },
            { name: '斫轮妙手', desc: '技艺通神，万物上手即成利器，朽木亦可斫出绝伦之器。', spirit: '斫轮', artifact: '鬼斧', cost: '日常无代价，逆天时轻微代价（可逆），神器可减轻' },
            { name: '白泽录异', desc: '通晓万物之名与弱点，一眼看穿对手软肋与秘辛。', spirit: '白泽', artifact: '万灵图', cost: '日常无代价，逆天时轻微代价（可逆），神器可减轻' },
            { name: '缱绻同心', desc: '以羁绊为锁，将二人命运相连，共享所受、分担所痛。', spirit: '缱绻', artifact: '并蒂莲', cost: '日常无代价，逆天时轻微代价（可逆），神器可减轻' }
        ];

        var specialDataT6 = [
            { name: '不周擎天', desc: '背负擎天之力，一怒可镇山河，万军辟易。', spirit: '不周', artifact: '天缺', blood: '撑天血脉', cost: '逆天时中等代价（可逆），神器可减轻' },
            { name: '鸿蒙初开', desc: '身负开天辟地之初始之力，举手投足镇压万法。', spirit: '鸿蒙', artifact: '玄黄', blood: '鸿蒙血脉', cost: '逆天时中等代价（可逆），神器可减轻' },
            { name: '轮回往生', desc: '生死轮转往复，可在轮回间隙窥见前世今生，掌生死之门。', spirit: '轮回', artifact: '彼岸花', blood: '轮回血脉', cost: '逆天时中等代价（可逆），神器可减轻' },
            { name: '万法归一', desc: '化繁为简，万法归宗，一切招式在你眼中皆可拆解为一。', spirit: '归一', artifact: '混元珠', blood: '归一血脉', cost: '逆天时中等代价（可逆），神器可减轻' },
            { name: '浩然正气', desc: '胸中浩然之气充塞天地，涤荡邪祟，克尽阴私。', spirit: '浩然', artifact: '醒世钟', blood: '浩然血脉', cost: '逆天时中等代价（可逆），神器可减轻' },
            { name: '须弥纳芥', desc: '纳须弥于芥子，一方天地收放自如，储物、困敌、遁形皆可。', spirit: '须弥', artifact: '乾坤袋', blood: '须弥血脉', cost: '逆天时中等代价（可逆），神器可减轻' },
            { name: '星汉灿烂', desc: '引星汉之力倾泻而下，银河垂落，万物俯首。', spirit: '星汉', artifact: '北辰', blood: '星汉血脉', cost: '逆天时中等代价（可逆），神器可减轻' },
            { name: '自定义', desc: '自拟全部设定（武魂/神器/血脉）', spirit: '', artifact: '', blood: '', cost: '逆天时中等代价（可逆）' }
        ];
        ...
        var stageData = [
            ...
            { id: "第零阶段", name: "神界遗孤·金龙王封印（开端前）", age: "0岁", date: "龙王历630年1月18日", icon: "🌌", shot: "万古神界崩裂的碎片坠入斗罗大陆的夜空。我睁开眼时，天穹的裂缝正在愈合——一枚金色的光核坠向远方的山村，随之而来的是婴儿的啼哭。命运在那一刻分岔：我的故事，将与那道金光交错。", events: ["神界乱流，金龙王破封，神核注入婴儿体内","唐三设下18道封印后送子下界","被唐孜然夫妇收养，取名唐舞麟"], openers: ["循金光追去","旁观这场天命","隐入山村暗处"] },



            { id: "第一阶段", name: "东海学院·蓝银觉醒", age: "6岁", date: "龙王历636年1月-2月", icon: "🌱", shot: "东海城的冬日清晨，红山学院门口排着等待觉醒的孩子。轮到我时，测试水晶纹丝不动——台下传来窃笑。只有角落里那个男孩，捧着被鉴定为废武魂的蓝银草，眼神像埋着火。这座小城的命运，正要被两个“废物”改写。", events: ["红山学院武魂觉醒仪式，蓝银草被判定为废武魂","因天生神力被关注，但魂力低下仍受歧视","金龙王封印出现裂痕，身体开始出现异常"], openers: ["走近觉醒广场","打听红山学院","远远旁观窃笑"] },



            { id: "第二阶段", name: "天生神力·娜儿之约", age: "6岁", date: "龙王历636年2月-3月", icon: "⚡", shot: "街角传来人群的惊呼——一个瘦小的男孩一拳砸碎了青石阶。他身边站着个银发少女，正安静地看他擦手上的血。她叫娜儿。那天傍晚，我听见他低声对她说：“我会保护你。”谁也没想到，这句话后来震动了一个时代。", events: ["街头一拳打碎石阶，展现超常力量","遇到失忆的娜儿，将其带回家中生活","与娜儿约定，承诺将来保护她"], openers: ["跟上那男孩","打量银发少女","留在街角观望"] },



            { id: "第三阶段", name: "东海学院·拜师舞长空", age: "6岁", date: "龙王历636年9月", icon: "🗡️", shot: "东海学院教务处，一个白发青年把一柄细剑搁在桌上，语气冷淡：“我只收一个学生。”全院的孩子都屏住了呼吸。他最终看向人群——指向了那个沉默的蓝银草少年。“你，跟我来。”剑光起处，学院的规矩被劈开了一道口子。", events: ["东海学院入学考核，通过基础测试","舞长空发现其潜力，破格收为弟子","初次了解唐门历史与暗器百解"], openers: ["挤进教务处","打听舞长空","门外候着"] },



            { id: "第四阶段", name: "加入唐门·锻造初途", age: "6岁-7岁", date: "龙王历636年9月-12月", icon: "🔨", shot: "铁匠铺的火星溅上我的袖口。门内，一群唐门外门弟子围着一块陨铁争论不休，那个蓝银草少年握锤的姿势生涩却专注，每一锤落下都带着不合年纪的沉稳。他在学锻造。而我知道，他同时也在锻造他自己的路。", events: ["通过唐门入门考核，成为唐门外门弟子","学习锻造基础，首次接触千锻概念","展现远超同龄人的锻造天赋"], openers: ["走进铁匠铺","寻唐门弟子攀谈","街口看热闹"] },



            { id: "第五阶段", name: "结识伙伴·雏形初现", age: "7岁", date: "龙王历637年1月-3月", icon: "🤝", shot: "学院走廊里，两个少年扭打成一团，灰尘里滚出几声闷响。谁也没料到，这一架打出了后来闻名大陆的搭档。旁边扎马尾的少女抱着本古籍看热闹，唇边带着笑。零班的人正在一个接一个地聚齐——而我，恰好站在了风暴眼里。", events: ["与谢邂因冲突相识，后化敌为友","许小言插班加入，星轮冰杖武魂展示","团队默契初步建立"], openers: ["劝架拉开两人","找马尾少女搭话","走廊边看这场架"] },



            { id: "第六阶段", name: "零班成军·联赛初战", age: "7岁", date: "龙王历637年3月-6月", icon: "🏁", shot: "联赛开幕的礼炮在操场上炸开。零班——那个全校没人看好的班，站在最角落。转学生古月站在唐舞麟身边，像一片安静的海。哨声响起时，我看见他们十指扣住彼此的手腕：“七位一体！”全场哗然。", events: ["古月转学至东海学院，展现超强实力","舞长空宣布零班正式成立","首次参加学院联赛，配合初显威力"], openers: ["走近零班阵营","找古月攀谈","观众席看首战"] },



            { id: "第七阶段", name: "史莱克考核·叩关入门", age: "7岁-8岁", date: "龙王历637年9月", icon: "🏰", shot: "史莱克城的大门在晨雾中升起。海神湖的水汽扑在脸上，黄金古树的枝叶在阳光下像流淌的金液。今天是补考日——精神威压、斗兽场、铡刀门。穿过最后那道门的少年浑身是血，却笑得张扬。他成了史莱克的工读生。", events: ["升灵台试炼，突破第二道封印（黄金龙体）","史莱克补考：精神威压、斗兽场、铡刀门、灵锻考核","浊世出面，破格录取为零班工读生"], openers: ["跟在考核队伍后","打听补考规则","站在铡刀门外"] },



            { id: "第八阶段", name: "班长竞选·班级之争", age: "约13岁", date: "龙王历637年9月-12月", icon: "⚔️", shot: "擂台四周挤满了人。零班内部的对决——唐舞麟对舞丝朵，拳风扫得观战席上的校服猎猎作响。这不仅是班长的争夺，更是这个新生班级第一次把“服气”两个字打出来。我在人群中听见有人小声说：“以后跟着他，能赢。”", events: ["班长争霸战，与舞丝朵对决","年级对抗赛初露锋芒","班级凝聚力逐步形成"], openers: ["挤进擂台前排","问身边观战者","远远看这场对决"] },



            { id: "第九阶段", name: "锻造委员·浊世传艺", age: "约13岁-14岁", date: "龙王历638年1月-3月", icon: "🔥", shot: "锻造室里的温度能把人的眉毛燎卷。那位暴躁的老前辈枫无羽拍着案台吼：“笨！这块铁不该这么走锤！”骂声里，一记又一记带着怒火的锤法却落进少年手里。金龙惊天第一式，就是在这样的骂声中悄悄生了根。", events: ["枫无羽强收为徒，锻造师协会打工","浊世传授金龙惊天第一式","锻造水平突破灵锻"], openers: ["走进锻造室","寻枫无羽拜师","炉火边看锤法"] },



            { id: "第十阶段", name: "武魂融合·神龙初现", age: "约14岁", date: "龙王历638年3月-6月", icon: "🐉", shot: "年级对抗赛最后一回合。唐舞麟与古月的身影在光芒中重合——七彩龙影冲天而起，威压让全场的魂导灯同时熄灭。那一刻，连裁判都忘了吹哨。人群炸开，而我忽然明白：他们俩之间，藏着远超同学的情愫和秘密。", events: ["年级对抗赛中意外触发武魂融合技","七彩龙影震惊全场","老唐现身警告，禁止再次使用"], openers: ["冲进赛场查看","追问老唐是谁","看台上震撼观望"] },



            { id: "第十一阶段", name: "蓝银皇觉醒", age: "约14岁", date: "龙王历638年9月", icon: "🌿", shot: "深海训练场，水压把光线压成一条条细线。那个少年在水底蜷成胎儿般的姿势，整整四十九天。当他被拖上来的那天，掌心的蓝银草蜕变成了皇者的金蓝——草叶舒展的瞬间，整片海水仿佛都在臣服。", events: ["深海特训四十九天，承受极限压力","牧野以特殊手法激发血脉","蓝银草蜕变，二次觉醒为蓝银皇"], openers: ["潜近训练场","找牧野打听","岸边等少年上岸"] },



            { id: "第十二阶段", name: "星罗联谊·群英荟萃", age: "约14岁", date: "龙王历638年9月-10月", icon: "🚢", shot: "星罗号的甲板上灯火通明，乐声浮在海面上。各国的青年才俊端着酒杯穿梭，礼貌的笑容下是暗流。我第一次见到这么大阵仗的社交场——而那个穿着礼服的蓝银草少年，正被星罗帝国的贵族小姐们围在中间，一脸窘迫。", events: ["星罗号巨轮联谊宴会","结识星罗帝国各方青年才俊","与怪物学院选手初次交锋"], openers: ["登上星罗号","找青年才俊攀谈","甲板角落观察"] },



            { id: "第十三阶段", name: "星罗大赛·小组赛", age: "约14岁", date: "龙王历638年10月-11月", icon: "🥊", shot: "星罗大赛的擂台上，欢呼声像潮水一样涨落。唐舞麟所在的队伍一路横扫小组赛。我看得分明：他的魂技还带着几分青涩，可那股子“打不倒”的狠劲，让所有对手都皱起了眉头。", events: ["小组赛多场连胜","史莱克七怪配合愈发默契","引起星罗帝国高层关注"], openers: ["挤进观众席","打听赛程安排","场边看七怪配合"] },



            { id: "第十四阶段", name: "星罗大赛·夺冠扬名", age: "约14岁", date: "龙王历638年11月-12月", icon: "🏆", shot: "决赛最后一刻，七彩龙影与对手的武魂轰然相撞。龙跃倒在台上，唐舞麟拄着黄金龙枪站起——那是他第一次在天下人面前拔出这把枪。观众席沉默了半秒，随后爆发出海啸般的欢呼。史莱克的名字，从此响彻大陆。", events: ["个人赛连战连捷","决赛龙跃重创唐舞麟，牧野出手相救","冲破第六道封印，拔出黄金龙枪","七对七神龙变碾压龙跃，史莱克夺冠"], openers: ["冲上决赛看台","赛后找牧野询问","人群里看夺冠"] },



            { id: "第十五阶段", name: "龙谷行动·启程", age: "约15岁", date: "龙王历639年1月", icon: "🗺️", shot: "龙谷的入口像一个巨大的咽喉，吞吐着远古的风。唐门召集令一下，各色魂师在谷外汇合。有人兴奋，有人不安。那个背负重任的蓝银草少年站在最前——他的背影告诉我：此去，凶险万分，却也注定名动天下。", events: ["唐门发布龙谷行动召集令","与星罗帝国选手组队进入","穿越龙谷入口的能量屏障"], openers: ["报名龙谷行动","寻唐门弟子组队","谷口观望形势"] },



            { id: "第十六阶段", name: "龙谷探秘·千日葬龙", age: "15岁-18岁", date: "龙王历639年1月-642年1月", icon: "🦴", shot: "龙谷深处，巨龙的骸骨绵延如山。三年四个月——他一个人，一柄锤，为那些从未被安葬的龙王修起了墓。锤声在空旷的谷底回荡了上千个日夜。我远远看着那个沉默的身影，第一次懂得：有些力量，是从“敬畏”里长出来的。", events: ["进入龙谷，武魂被封印","吸收龙云强化体魄，救助戴云儿","龙墓安葬巨龙骸骨（耗时三年四个月）","获赠山龙王躯干骨"], openers: ["深入龙谷腹地","帮少年修墓","谷口留守接应"] },



            { id: "第十七阶段", name: "金龙王核心传承", age: "约18岁", date: "龙王历642年1月-2月", icon: "✨", shot: "龙谷最深处，金色的光柱直冲天穹。当金龙王的核心融入他胸口时，整个龙谷都在震颤，沉睡的龙魂发出低吟，仿佛在行礼。封印再度松动——他闭上眼睛，再睁开时，眼底有金芒一闪而过。他握了握拳：“该回去了。”", events: ["通过龙族最终考验","金龙王核心融入体内","封印进一步松动，力量暴涨"], openers: ["靠近金色光柱","问守护龙魂","远处护法观望"] },



            { id: "第十八阶段", name: "回归史莱克·海神缘前", age: "约18岁", date: "龙王历642年9月", icon: "🎓", shot: "史莱克城用英雄的礼遇迎接归来的少年。海神湖的桥上站满了人，他走过欢呼的人潮，目光却在人群中搜寻着什么。海神缘大会将至——今晚的湖水，注定不太平静。", events: ["从龙谷归来，修为大增","史莱克学院以英雄之礼迎接","海神缘大会即将召开"], openers: ["挤进迎接人潮","打听海神缘大会","桥上远远看着"] },



            { id: "第十九阶段", name: "海神缘定情", age: "约18岁", date: "龙王历642年9月", icon: "🌸", shot: "海神缘大会，红绳在月光下牵起宿命。当那根绳子的另一端落入古月手中时，全场都屏住了呼吸。两个肩负着对立使命的人，此刻只是并肩站在湖心，谁也不愿松手。风把他的话送得很远：“这一次，我不会放开你。”", events: ["海神缘大会上力压群雄","与古月互诉心声","正式确立情侣关系"], openers: ["走近湖心看台","问红绳规则","岸边静静看着"] },



            { id: "第二十阶段", name: "魔鬼岛特训启程", age: "约18岁", date: "龙王历642年10月", icon: "⛵", shot: "船头劈开灰黑色的海浪，魔鬼岛的轮廓在雾中若隐若现。岛上据说有七位能把人逼疯的老怪物。同行的学员们面色凝重，而那个蓝银草少年站在桅杆下，望着岛屿的方向，眼里竟有一丝跃跃欲试。", events: ["收到魔鬼岛特训征召","与七怪一同登船前往","抵达魔鬼群岛"], openers: ["报名魔鬼岛","找七怪攀谈","码头送行观望"] },



            { id: "第二十一阶段", name: "魔鬼岛极限磨砺", age: "18岁-19岁", date: "龙王历642年10月-643年3月", icon: "🌋", shot: "魔鬼岛的试炼没有一天是轻松的。碎骨重组——骨头一寸寸裂开又接上的痛，让再硬气的人都惨叫出声。他也在叫，但叫完又站起来：“再来。”生命潮汐里，一粒魂核的雏形在他体内悄然凝聚。", events: ["魔鬼岛七老魔试炼（碎骨重组、恐惧幻境、欲望测试）","生命潮汐中凝聚魂核雏形","团队配合愈发默契"], openers: ["闯进试炼场","向七老魔求教","旁观磨砺过程"] },



            { id: "第二十二阶段", name: "北海军团偷飞机", age: "约19岁", date: "龙王历643年3月-4月", icon: "✈️", shot: "深夜的北海军团基地，探照灯扫过停机坪。一伙人贴着阴影潜行——目标是那架新型机甲。警报炸响的那一刻，我看见他拽着驾驶杆把机甲拉出机库，迎面撞上三架拦截机，愣是靠操作把追兵甩进了山谷。", events: ["奉命窃取北海军团新型机甲","成功完成任务并全身而退","引发军方震动，反被嘉奖"], openers: ["跟上潜入小队","打听机甲情报","基地外望风"] },



            { id: "第二十三阶段", name: "圣灵教初现", age: "约19岁", date: "龙王历643年4月-6月", icon: "🌑", shot: "最近两个月，大陆各地接连出现邪魂师的痕迹——失踪的孩子、被掏空的魂兽巢穴。传灵塔与联邦高层里，也开始有人收到诡异的黑信。茶余饭后，人们压低声音议论着三个字：圣灵教。空气里有什么东西正在悄悄变质。", events: ["大陆各地多次出现邪魂师作乱","圣灵教渗透传灵塔与联邦高层","史莱克学院开始警觉"], openers: ["追查失踪线索","打听圣灵教传闻","茶楼听闲话"] },



            { id: "第二十四阶段", name: "深渊威胁显现", age: "约19岁", date: "龙王历643年6月-9月", icon: "🕳️", shot: "极北之地的边境哨所发来加急传信：深渊裂缝正在扩大，黑色的潮汐吞没了两个补给站。血神军团的警报拉响时，我看见老兵们擦拭武器的动作变快了。暗涌多年的大陆，终于要被推到台前。", events: ["深渊生物开始在极北之地出现","血神军团发出警报","联邦高层内部分歧加剧"], openers: ["前往极北边境","向血神军团打听","观望局势变化"] },



            { id: "第二十五阶段", name: "史莱克浩劫", age: "约19岁", date: "龙王历643年9月-10月", icon: "💥", shot: "那一天，史莱克城的天空被一道光撕开——弑神级炮弹落下。我脚下的土地在震颤，海神湖的水被气浪掀上天空又砸落。昔日辉煌的学院在火海中坍塌，海神阁的旗帜坠入烟尘。这个世界，被一炮轰进了深渊时代。", events: ["圣灵教发射弑神级炮弹","史莱克城被毁，云冥牺牲","海神阁几乎全军覆没"], openers: ["冲进火海救人","寻找幸存师生","废墟外震惊"] },



            { id: "第二十六阶段", name: "流亡之路", age: "19岁-20岁", date: "龙王历643年10月-12月", icon: "🥾", shot: "地下避难层的通风管呜呜作响。史莱克残存的师生换上便装，分头消失在城市的各个角落。他带着古月西行，临别时对我们说：“活着，才有以后。”我开始习惯在夜里赶路，习惯把名字藏起来——圣灵教的眼线，已经布满了大陆。", events: ["七怪幸存，进入地下避难层","分兵潜伏，各自历练","唐舞麟带古月前往西方"], openers: ["跟上西行队伍","化装潜行入城","藏身地下避难层"] },



            { id: "第二十七阶段", name: "冰火两仪眼", age: "约20岁", date: "龙王历644年1月-6月", icon: "⚗️", shot: "冰火两仪眼的泉水一半灼烫一半彻骨，泉边竟长着只在传说里存在的仙草。当那株绮罗郁金香亮起光芒时，六大植物凶兽的身影自光芒中浮现——它们选择献祭，成为他的本命魂灵。那一年，他沉默地变强，强到让人心疼。", events: ["冰火两仪眼，六大植物凶兽献祭","绮罗郁金香等成为本命魂灵","实力暴涨，奠定魂圣基础"], openers: ["循仙草光芒而去","求问植物凶兽","泉畔静观蜕变"] },



            { id: "第二十八阶段", name: "极北之地冒险", age: "20岁-21岁", date: "龙王历644年6月-12月", icon: "❄️", shot: "极北的风像刀子，刮在脸上生疼。雪原深处，深渊生物的黑色剪影时隐时现。我与一队魂师结成临时防线，远处，那个身影正在与一只深渊领主缠斗——自然之种在他胸口发光，像雪夜里的一盏灯。", events: ["极北之地遭遇深渊生物袭击","与当地魂师势力建立联系","自然之种进一步生长"], openers: ["加入临时防线","寻当地魂师结盟","雪原边缘观察"] },



            { id: "第二十九阶段", name: "唐昊现身", age: "约21岁", date: "龙王历645年1月-3月", icon: "🌩️", shot: "雨夜，一个邋遢的男人敲开了我们的避雨小屋。他一身酒气，却在看见唐舞麟时目光骤然清明。“像，太像了。”他喃喃着，忽然周身气息暴涌，昊天锤的虚影在雨幕中一闪而逝。那是少年第一次触摸到自己的身世。", events: ["唐昊以神识之体降临","告知唐三与神界的安排","唐舞麟初知自己的神界身世"], openers: ["敲门进屋避雨","追问少年身世","屋檐下听谈话"] },



            { id: "第三十阶段", name: "圣灵教终极阴谋", age: "约21岁", date: "龙王历645年3月-6月", icon: "🕸️", shot: "传灵塔的顶层会议厅大门紧闭，据说已被邪魂师渗透；联邦最高议会的表决屡屡被神秘力量搅黄。茶馆里的人们开始不敢议论国事。那张看不见的网正一寸寸收紧——圣灵教筹备多年的终极阴谋，就要收网了。", events: ["圣灵教渗透联邦最高议会","传灵塔被邪魂师控制","深渊位面与圣灵教暗中勾结"], openers: ["潜入传灵塔","追查黑信来源","茶馆静听风声"] },



            { id: "第三十一阶段", name: "深渊决战开启", age: "约21岁", date: "龙王历645年6月-9月", icon: "⚔️", shot: "极北防线上，联军旌旗猎猎。深渊裂口像一道黑色的伤口横亘大地，无数狰狞的身影正从其中涌出。他站在联军最前方，生命子树的光辉在他身后铺开成墙。号角吹响的那一刻，我握紧武器，冲进了那片黑色的潮水。", events: ["极北防线全面告急","生命子树扎根极北","唐舞麟统帅联军迎战"], openers: ["冲进黑色潮水","守生命子树","后方支援伤员"] },



            { id: "第三十二阶段", name: "使命对立", age: "21岁-22岁", date: "龙王历645年9月-12月", icon: "💔", shot: "决战胜利的喜悦还没来得及扩散，更大的风暴降临——古月娜的身份暴露了。魂兽之主与人类领袖，隔着整个大陆的对立站在了他面前。那晚我看见他站在营帐外，望着星空站了一整夜。", events: ["古月娜身份彻底暴露（银龙王）","魂兽阵营与人类阵营对峙","两人因使命对立而决裂"], openers: ["走向对峙前线","找古月娜谈谈","营帐外看着"] },



            { id: "第三十三阶段", name: "最终对决", age: "约22岁", date: "龙王历646年1月-3月", icon: "☄️", shot: "万米高空之上，金色与银色的光芒碰撞，云层被撕成碎片。龙神之力对银龙王之力——大陆上最强的两个人，正在用最惨烈的方式相爱。每一次对撞都让大地颤抖。我仰头望着那两道纠缠的光，喉咙发紧。", events: ["两人于万米高空对决","龙神之力VS银龙王之力","难分胜负，双双力竭"], openers: ["仰望高空对决","追寻两道光芒","守住大地等待"] },



            { id: "第三十四阶段", name: "永冻冰封", age: "26岁", date: "龙王历656年1月18日", icon: "🧊", shot: "极北冰海上空，银色的光芒铺满苍穹。她发动了冰封禁咒——整片海域在瞬息间凝成永恒的白。两道身影在坠落中相拥，冰层合拢，将他们封在海底深处。世界安静了。可我知道，那个关于重生的传说，才刚刚埋下种子。", events: ["古月娜发动冰封禁咒","两人相拥坠入极北冰海","身体被永恒冰层包裹，沉入海底","为终极斗罗唐舞麟复活埋下伏笔"], openers: ["冲向冰海边缘","记住这一幕","静静送别传说"] }
        ...
        var secondProfDescs = {'0':'尚未入门，还在观摩学习。','1':'初窥门径，仅掌握最基础的操作手法。','2':'略有所成，能独立完成简单的作品。','3':'技艺初显，在当地小有名气。','4':'炉火纯青，作品已具备一定水准。','5':'大师之姿，行业内公认的佼佼者。','6':'宗师境界，作品被各方争相收藏。','7':'巨匠风范，影响一方技艺传承。','8':'泰斗级存在，作品代表时代巅峰。','9':'传奇不朽，技艺已臻化境，前无古人。'};
        ...
        function updateIdentityByCamp(){
            ...
            var identities = (campIdentityLinks[camp] || ['无']).slice();

            fixedIdentityOptions.forEach(function(id){ if(identities.indexOf(id) === -1) identities.push(id); });
        ...
        function validateRings(){
            ...
            var spiritYear = getSel('ssy');
            var spiritWeight = getRingYearWeight(spiritYear);
            var ringMin = null;
            rings.forEach(function(ring){ var w = getRingYearWeight(ring.year); if(ringMin === null || w < ringMin) ringMin = w; });
            if(spiritYear && spiritYear !== '无' && rings.length > 0 && ringMin < spiritWeight){
                hasIssue = true;
                issues.push('魂环年限（' + rings.map(function(r){ return r.year; }).join('、') + '）低于魂灵年限（' + spiritYear + '），请确认合理性');
            }
        ...
        function updateSpiritDot(){
            ...
            if(year === '无'){ fields.spiritDot.className = 'spirit-dot s-white'; fields.spiritDot.style.background = '#a89880'; return; }
        ...
        function populateStageSelect(){
            ...
            stageData.forEach(function(s){
                ...
                opt.textContent = (s.icon ? s.icon + ' ' : '') + s.id + ' · ' + s.name;
        ...
        function onStageSelect(){
            ...
            fields.stageDisplayId.textContent = (stage.icon ? stage.icon + ' ' : '') + stage.id;
            ...
            if(fields.stageShotPreview){ fields.stageShotPreview.textContent = stage.shot || ''; fields.stageShotPreview.style.display = stage.shot ? 'block' : 'none'; }
        ...
        function onStageEventSelect(){



            fields.stageEventDisplay.textContent = fields.stageEventSelect.value;



            var stageId = fields.stageSelect.value;
            ...
            if(stageId){
                ...
                // (v5) 选切入事件不再覆写开场白——留空由「降临阶段首帧画面」兜底
        ...
        function updateSpecialDesc(){
            ...
            var data = specialData[tier] || [];
            var found = null;
            for(var i=0; i<data.length; i++){ if(data[i].name === name){ found = data[i]; break; } }

            // 按等级更新字段显隐与标签名（lz确认规则）
            var isLowTier = (tier === 't1' || tier === 't2' || tier === 't3');
            var isHighTier = (tier === 't5' || tier === 't6');
            if(fields.specialWeaponWrap) fields.specialWeaponWrap.dataset.hidden = isLowTier ? '1' : '0';
            if(fields.spiritLabel) fields.spiritLabel.textContent = '专属武魂';
            if(fields.artifactLabel) fields.artifactLabel.textContent = isHighTier ? '专属神器' : '神器';
            if(fields.bloodLabel) fields.bloodLabel.textContent = (tier === 't6') ? '专属血脉' : '血脉';
            ...
            if(found && found.name === '自定义'){
                ...
                descText = '📖 ' + (fields.customSpecialName.value || '自定义能力') + '：' + (fields.customSpecialDesc.value || '请填写描述');
                fields.specialWeapon.value = '';
                fields.specialArtifact.value = '';
                fields.bloodName.value = '';
                lastAutoSpirit = '';
                costText = (tier === 't5') ? '日常无代价，逆天时轻微代价（可逆）' :
                           (tier === 't6') ? '逆天时中等代价，可借神器减轻' : '';
                ...
                // 专属武魂自动填充到武魂与魂力的武魂名称（如玩家未手填或与自动值一致时覆盖）
                if(found.spirit && (!fields.msn.value || fields.msn.value === lastAutoSpirit)){
                    fields.msn.value = found.spirit;
                }
                lastAutoSpirit = found.spirit || '';
                fields.specialArtifact.value = found.artifact || '';
                if(found.blood){
                    fields.bloodName.value = found.blood;
                    if(!fields.bloodAwaken.value) fields.bloodAwaken.value = '未觉醒';
                } else { fields.bloodName.value = ''; }
                costText = (tier === 't5') ? '日常无代价，逆天时轻微代价（可逆），神器可减轻' :
                           (tier === 't6') ? '逆天时中等代价（可逆），神器可减轻' : '';

            } else {

                if(fields.specialWeaponWrap) fields.specialWeaponWrap.dataset.hidden = '0';
                if(fields.specialArtifactWrap) fields.specialArtifactWrap.dataset.hidden = '0';
                if(fields.bloodWrap) fields.bloodWrap.dataset.hidden = '0';

            }

            if(fields.costDesc) fields.costDesc.textContent = costText;
            fields.stDesc.textContent = descText;

            // 5/6级：把「天生异禀」加段自动填充进开场白与场景（greeting），已存在则不重复
            var originTxt = getSpecialOriginText();
            if(originTxt && fields.greeting && fields.greeting.value.indexOf('天生异禀') === -1){
                fields.greeting.value = (fields.greeting.value ? fields.greeting.value + '\n\n' : '') + originTxt;
            }
...
function getSpecialDisplay(){
            ...
            var parts = [name];
            if(found.spirit) parts.push('武魂·' + found.spirit);
            if(found.artifact) parts.push('神器·' + found.artifact);
            if(found.blood){
                var bl = fields.bloodAwaken.value || '未觉醒';
                parts.push('血脉·' + found.blood + '（' + bl + '）');
            }
            return parts.join(' / ');
        }
        ...
        function getSpecialOriginText(){
            // 5级/6级：「自幼与众不同」背景叙述段（用于开场白与场景）
            if(currentTier !== 't5' && currentTier !== 't6') return '';
            var name = fields.st.value;
            if(!name) return '';
            var data = specialData[currentTier] || [];
            var found = null;
            ...
            if(!found) return '';
            if(name === '自定义'){
                var ccn = fields.customSpecialName.value || '自定义能力';
                return '【天生异禀】你自幼便与旁人不同，' + ccn + '如同宿命般刻在你的骨血里。旁人只当你运气好，唯有你自己知道——这份与众不同，是你与生俱来的印记，也在暗中引着你走向某条注定之路。';
            }
            if(currentTier === 't5'){
                var art = found.artifact ? '，与神器「' + found.artifact + '」之间更有着说不清的共鸣' : '';
                return '【天生异禀】你自幼便与旁人不同，体内仿佛沉睡着一缕神性' + art + '。幼时起，你便能在梦中窥见他人望尘莫及的景象，这份直觉与气运让你一路走来总有惊无险。世人只道你天赋卓绝，却不知那都是' + found.name + '在冥冥中护佑着你，静待有朝一日真正苏醒。';
            }
            var bl = fields.bloodAwaken.value || '未觉醒';
            var bloodPart = found.blood ? '血脉「' + found.blood + '」' : '一缕连你自己都说不清来历的力量';
            return '【天生异禀】你自幼便与旁人不同，觉醒的' + bloodPart + '（' + bl + '）如同深埋地底的种子，在岁月里悄然生长。旁人只当你是运气逆天的天才，唯有你自己知道，那股力量与生俱来、如影随形，也在一次次生死关头替你挡下本不该躲过的劫数。';
        }
        ...
        function syncSpiritRings(withToast){
            updateSpiritDot();
            var type = getSel('sst');
            var year = getSel('ssy');
            if(type !== '无魂灵' && year && year !== '无'){
                var countMap = {'十年':1,'百年':2,'千年':2,'万年':2,'十万年':2,'凶兽':2};
                var n = countMap[year] || 1;
                var changed = rings.length !== n || rings[0] && rings[0].year !== year;
                rings = [];
                for(var i=0; i<n; i++){ rings.push({ year: year }); }
                localStorage.setItem('soul_rings_v21', JSON.stringify(rings));
                renderRings();
                updateRingInfo();
                validateRings();
                if(withToast && changed) showToast('魂环已同步为 ' + n + ' 个' + year + '魂环');
            } else if(type === '无魂灵') {
                if(rings.length > 0){ rings = []; localStorage.setItem('soul_rings_v21', JSON.stringify(rings)); renderRings(); updateRingInfo(); validateRings(); }
            }
            saveDraft();
        }

        function updateSpiritYearVisibility(){
            var type = getSel('sst');
            var wrap = $('spiritYearWrap');
            if(!wrap) return;
            if(type === '无魂灵'){ wrap.style.display = 'none'; }
        ...
        function collectData(){
            ...
            return {
                ...
                "出身与阵营": { "出身地": getVal('og')||'', "所属阵营": getSel('fc'), "阵营身份": getSel('fbg') },
                ...
                "降临阶段": stage ? { "阶段": stage.id, "名称": stage.name, "年龄": stage.age, "时间": stage.date, "切入事件": eventVal||'', "icon": stage.icon||'', "首帧画面": stage.shot||'', "来意": getVal('stageGoal')||'', "选项": stage ? (stage.openers||[]) : [] } : null,
        ...
        var saveDraft = debounce(function(){
            ...
            try {
                ...
                data._greetingRaw = getVal('greeting') || '';
                data._stageGoal = getVal('stageGoal') || '';
        ...
        function loadDraft(){
            ...
            try {
                ...
                var map = {
                    ...
                    'og':'出身与阵营.出身地','fc':'出身与阵营.所属阵营','fbg':'出身与阵营.阵营身份',
                ...
                if(data._greetingRaw !== undefined && data._greetingRaw !== null) data['开场白'] = data._greetingRaw;
        ...
        function generatePersonaText(){
            ...
            var originText = getSpecialOriginText();
            var greetingFilled = d.开场白 && d.开场白.indexOf('天生异禀') > -1;
            if(originText && !greetingFilled){ lines.push(''); lines.push(originText); }
        ...
        function generateGreeting(){
            ...
            var minor = [];
            if (d.斗铠 && d.斗铠.斗铠名称 && d.斗铠.斗铠名称 !== '未填写' && d.斗铠.斗铠名称 !== '') minor.push('斗铠' + d.斗铠.斗铠名称 + '(' + d.斗铠.斗铠等级 + ')');
            if (d.魂骨 && d.魂骨.已装备魂骨 && d.魂骨.已装备魂骨 !== '0/7') minor.push('魂骨' + d.魂骨.已装备魂骨);
            if (d.第二职业 && d.第二职业.职业类型 && d.第二职业.职业类型 !== '无') minor.push('第二职业' + d.第二职业.职业类型 + '(' + d.第二职业.等级 + ')');
            if (d.机甲 && d.机甲.机甲等级 && d.机甲.机甲等级 !== '无') minor.push('机甲' + d.机甲.机甲等级);
            if (d.特殊能力 && d.特殊能力 !== '无' && d.特殊能力 !== '') minor.push('特殊能力' + d.特殊能力);
            if (d.背包 && d.背包.length) minor.push('背包' + d.背包.join('、'));
            if (row3.length + minor.length > 6 && minor.length) { row3.push('装备·' + minor.join('·')); }
            else { row3 = row3.concat(minor); }
            ...
            if (d.降临阶段) {
                L.push('');
                var _stageLine = '【降临】';
                if (d.降临阶段.icon) _stageLine += d.降临阶段.icon + ' ';
                _stageLine += d.降临阶段.阶段 + ' · ' + d.降临阶段.名称;
                L.push(_stageLine);
                if (d.降临阶段.切入事件) L.push('【切入】' + d.降临阶段.切入事件);
                if (d.降临阶段.来意 && String(d.降临阶段.来意).trim()) L.push('【来意】' + String(d.降临阶段.来意).trim());
            }

            // ===== ④ 此刻（场景 + 开场白正文）=====
            var hasScene = d.场景设定 && String(d.场景设定).trim();
            var hasGreet = d.开场白 && String(d.开场白).trim();
            var hasShot = d.降临阶段 && d.降临阶段.首帧画面 && String(d.降临阶段.首帧画面).trim();
            if (hasScene || hasGreet || hasShot) {
                L.push('');
                if (hasScene) L.push('【场景】' + String(d.场景设定).trim());
                if (hasGreet) L.push('【此刻】' + String(d.开场白).trim());
                else if (!hasScene && hasShot) L.push('【此刻】' + String(d.降临阶段.首帧画面).trim());
            }
        ...
        function enterWorld(){
            ...
            var _goal = getVal('stageGoal') || '';
            if (!_goal && !getVal('greeting')) showToast('✦ 档案已铸就，开场白已复制！补充【来此目的】可让 AI 更精准起局', true);
            else showToast('✦ 档案已铸就，开场白已复制，准备降临斗罗大陆！');
        ...
        function bindEvents(){
            ...
            fields.ssy.addEventListener('change', function(){
                syncSpiritRings(true);
            });
            ...
            fields.sst.addEventListener('change', function(){ updateSpiritYearVisibility(); syncSpiritRings(false); });
            fields.ssn.addEventListener('input', function(){ updateSpiritYearVisibility(); syncSpiritRings(false); });
